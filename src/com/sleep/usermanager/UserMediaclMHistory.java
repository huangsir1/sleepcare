...
public class UserMediaclMHistory extends Activity {
	...
	public static UserMediaclMHistory instance = null; 
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.user_medical_m_history);
		instance=this;
		ExitActivity.getInstance().addActivity(this);
		Intent intent=getIntent();
		backiv=(ImageView) findViewById(R.id.imageView1_bsxz_m);
		backiv.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				UserMediaclMHistory.this.finish();
		...
		t1_1 = (TextView) findViewById(R.id.s_m_mmn);		
		...
		t1_2 = (TextView) findViewById(R.id.t_n_b_mmn);
		...
		t2_1 = (TextView) findViewById(R.id.g_x_y_mmn);
		...
		t2_2 = (TextView) findViewById(R.id.g_x_b_mmn);
		...
		t3_1 = (TextView) findViewById(R.id.x_l_s_j_mmn);
		...
		t3_2 = (TextView) findViewById(R.id.x_l_s_c_mmn);
		...
		t4_1 = (TextView) findViewById(R.id.b_q_z_s_mmn);
		...
		t4_2 = (TextView) findViewById(R.id.c_q_x_y_mmn);
		...
		t5_1 = (TextView) findViewById(R.id.n_x_g_j_b_mmn);
		...
		t5_2 = (TextView) findViewById(R.id.s_g_n_s_h_mmn);
		...
		t6_1 = (TextView) findViewById(R.id.z_j_j_y_w_mmn);
		...
		t6_2 = (TextView) findViewById(R.id.c_q_d_l_y_j_mmn);
		...
		t7_1= (TextView) findViewById(R.id.s_f_j_j_mmn);
		...
		t7_2= (TextView) findViewById(R.id.s_f_f_p_mmn);
		...
		t8_1= (TextView) findViewById(R.id.x_y_c_c_d_mmnn);
		t8_1.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				switch (status15) {
				case 0:
					t8_1.setTextColor(getResources().getColor(R.color.white));
					t8_1.setBackgroundResource(R.drawable.sregister0003);
					status15 = 1;
					break;
				case 1:
					t8_1.setTextColor(getResources().getColor(R.color.bs_zt_ys));
					t8_1.setBackgroundResource(R.drawable.sregister0002);
					status15 = 0;
					break;
				default:
					break;
		...
		mSubmit = (Button) findViewById(R.id.sure_submit1_mmn);
		mSubmit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {	
				...
				String whetherjjm=t7_1.getText().toString();
				String whetherfmhy=t7_2.getText().toString();
				String whetherxyccd=t8_1.getText().toString();
				...
				//是否绝经
				if (status13 == 1) {
					intent.putExtra("whetherjjm", whetherjjm);
				}else if(status13 == 0){
					intent.putExtra(null, whetherjjm);
				}
				//是否有OSAHS的家族史
				if (status14 == 1) {
				...
				intent.setClass(UserMediaclMHistory.this, UserQuestionActivity.class);
				intent.putExtra("ummhclose", 2);
