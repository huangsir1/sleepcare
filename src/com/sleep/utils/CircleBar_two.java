...
public class CircleBar_two extends View {
	...
	public CircleBar_two(Context context) {
		super(context);
		init(null, 0);
	}

	public CircleBar_two(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public CircleBar_two(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		// mColorWheelPaint.setColor(Color.rgb(255, 182, 193));
		mColorWheelPaint.setColor(Color.rgb(189, 252, 201));
		...
		mTextnum.setColor(Color.WHITE);
		// mTextnum.setColor(Color.rgb(135, 38, 87));

		mTextch = new Paint();
		mTextch.setAntiAlias(true);
		mTextch.setColor(Color.WHITE);
		// mTextch.setColor(Color.rgb(0, 191, 255));
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawArc(mColorWheelRectangle, 90, mSweepAnglePer, false,
				mColorWheelPaint);
		canvas.drawText(MyApplication.getContext().getString(R.string.xy_title),
