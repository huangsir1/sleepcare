...
public class CircleBar_three extends View {
	...
	public CircleBar_three(Context context) {
		super(context);
		init(null, 0);
	}

	public CircleBar_three(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public CircleBar_three(Context context, AttributeSet attrs, int defStyle) {
...
//		mTextP.setColor(Color.rgb(249, 135, 49));
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawArc(mColorWheelRectangle, 90, mSweepAnglePer, false,
				mColorWheelPaint);
		canvas.drawText(  "   "+ MyApplication.getContext().getString(R.string.ml_title), mColorWheelRectangle.centerX()
				- (mTextP.measureText(String.valueOf(mPercent) + "bpm") / 2),
				mPercent_y, mTextP);
		if(stepnumbernow == 0){
