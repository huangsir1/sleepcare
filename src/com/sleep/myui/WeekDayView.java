...
public class WeekDayView extends View {
	...
	private String[] weekString = new String[] {
			MyApplication.getContext().getString(R.string.sunday),
			MyApplication.getContext().getString(R.string.monday), 
			MyApplication.getContext().getString(R.string.tuesday),
			MyApplication.getContext().getString(R.string.wednesday),
			MyApplication.getContext().getString(R.string.thursday),
			MyApplication.getContext().getString(R.string.friday),
			MyApplication.getContext().getString(R.string.saturday) };
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < weekString.length; i++) {
			...
			if (text.indexOf(MyApplication.getContext().getString(R.string.sunday)) > -1 || text.indexOf(MyApplication.getContext().getString(R.string.saturday)) > -1) {
