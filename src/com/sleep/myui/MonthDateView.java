...
import com.sleep.utils.DateUtils;
...
public class MonthDateView extends View {
	...
	private int mCurrentColor = Color.parseColor("#2E8EE8");
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int day = 0; day < mMonthDays; day++) {
			...
			if (tv_week != null) {
				tv_week.setText(MyApplication.getContext().getString(R.string.no_) + weekRow + MyApplication.getContext().getString(R.string.week));
			}
		}
	}
