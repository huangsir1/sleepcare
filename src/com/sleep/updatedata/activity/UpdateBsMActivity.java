...
public class UpdateBsMActivity extends Activity {
	...
	private int stbs8_1_1 = 0;
	private int stbs8_1_2 = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.update_m_user_medical_history);
		ExitActivity.getInstance().addActivity(this);
		Intent intent = getIntent();
		sd = new PublicDaoImpl(UpdateBsMActivity.this);
		id = intent.getIntExtra("sexmid", -1);
		dh = sd.findAllDiabetesHyById(id);
		um = sd.findAllUserById(id);
		ep = sd.findAllEpworthById(id);
		sdialog = new SubmitDialog(UpdateBsMActivity.this);
		imageViewback = (ImageView) findViewById(R.id.imageView1_bs_mm);
		// imageViewback.setAlpha(0);
		imageViewback.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				UpdateBsMActivity.this.finish();
				overridePendingTransition(R.anim.right_left_out, R.anim.right_left_in);
			}
		});
		tbs1_1 = (TextView) findViewById(R.id.s_m_upbs_mm);
		...
		tbs1_2 = (TextView) findViewById(R.id.t_n_b_upbs_mm);
		...
		tbs2_1 = (TextView) findViewById(R.id.g_x_y_upbs_mm);
		...
		tbs2_2 = (TextView) findViewById(R.id.g_x_b_upbs_mm);
		...
		tbs3_1 = (TextView) findViewById(R.id.x_l_s_j_upbs_mm);
		...
		tbs3_2 = (TextView) findViewById(R.id.x_l_s_c_upbs_mm);
		...
		tbs4_1 = (TextView) findViewById(R.id.b_q_z_s_upbs_mm);
		...
		tbs4_2 = (TextView) findViewById(R.id.c_q_x_y_upbs_mm);
		...
		tbs5_1 = (TextView) findViewById(R.id.n_x_g_j_b_upbs_mm);
		...
		tbs5_2 = (TextView) findViewById(R.id.s_g_n_s_h_upbs_mm);
		...
		tbs6_1 = (TextView) findViewById(R.id.z_j_j_y_w_upbs_mm);
		...
		tbs6_2 = (TextView) findViewById(R.id.c_q_d_l_y_j_upbs_mm);
		...
		tbs7_1 = (TextView) findViewById(R.id.s_f_j_j_upbs_mm);
		...
		tbs7_2 = (TextView) findViewById(R.id.s_f_f_p_upbs_mm);
		...
		tbs8_1 = (TextView) findViewById(R.id.x_y_c_c_d_mmnn_upbs);
		if (dh.getWhetherxyccd() != null) {
			tbs8_1.setTextColor(getResources().getColor(R.color.white));
			tbs8_1.setBackgroundResource(R.drawable.sregister0003);
			tbs8_1.setOnClickListener(new OnClickListener() {

				@Override
				public void onClick(View v) {
					switch (stbs8_1_1) {
					case 0:
						tbs8_1.setTextColor(getResources().getColor(R.color.bs_zt_ys));
						tbs8_1.setBackgroundResource(R.drawable.sregister0002);
						stbs8_1_1 = 1;
						break;
					case 1:
						tbs8_1.setTextColor(getResources().getColor(R.color.white));
		...
		mtbsSubmit = (Button) findViewById(R.id.sure_submit1_upbs_mm);
		mtbsSubmit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String whetherjjm = tbs7_1.getText().toString();
				String whetherfmhy = tbs7_2.getText().toString();
				String whetherxyccd = tbs8_1.getText().toString();
				...
				if (stbs8_1_1 == 0 && stbs8_1_2 == 1) {
					dh.setWhetherxyccd(whetherxyccd);
				} else if (stbs8_1_1 == 1 && stbs8_1_2 == 0) {
				...
				if (isConnected || isConnected3g) {
					...
					mHandler.sendEmptyMessage(3);
					Toast.makeText(UpdateBsMActivity.this,
							UpdateBsMActivity.this.getString(R.string.modify_failed_please_open_the_network),
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				Toast.makeText(UpdateBsMActivity.this,
						UpdateBsMActivity.this.getString(R.string.history_revision_success), Toast.LENGTH_SHORT).show();
				break;
			case 1:
				Toast.makeText(UpdateBsMActivity.this,
						UpdateBsMActivity.this.getString(R.string.history_revision_failure), Toast.LENGTH_SHORT).show();
				break;
			case 2:
				...
				sdialog.setContent(UpdateBsMActivity.this
